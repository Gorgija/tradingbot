...
exports.gmailWatchLabels = (req, res) => {
  ...
  fs.readFile('credentials.json', (err, content) => {
    ...
    authorize(JSON.parse(content), watchLabels);
  });
  ...
  function watchLabels(auth) {
    ...
    gmail.users.watch({
      ...
      "resource": {
        ...
        "topicName": 'projects/trading-13/topics/crypto',
      }
      ...
      res.status(200).send({"return":  "ok" ,"time": Date.now() , "data" : data }); // Buffer.from(response.data, 'base64').toString()
    });
  }
